...
func (app *application) readJSON(
	...
	if err != nil {
		...
		case errors.As(err, &maxBytesError):
			return fmt.Errorf("body must be no longer than %d bytes", maxBytesError.Limit)
	...
	// Check if there is additional data in the request body
...
func (app *application) inactiveAccountResponse(
	...
	message := "your use account must be activated to access this resource"
	app.errorResponse(w, r, http.StatusUnauthorized, message)
}
